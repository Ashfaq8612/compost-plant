...
(function (window, document, $) {
  ...
  function changeMode(reverse) {
      var currentLayout = getCurrentLayout(),
          switchToLayout = '',
          prevLayout = localStorage.getItem(dataLayout + '-prev-skin', currentLayout);

      if (reverse) {
          if (prevLayout === 'light-layout') {
              // Switch to dark
      ...
      localStorage.setItem(dataLayout + '-prev-skin', switchToLayout);
      // Set Current skin in local db
      localStorage.setItem(dataLayout + '-current-skin', currentLayout);
