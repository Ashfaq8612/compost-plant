...
(function ($) {
    ...
    $.fn.simpleCropper = function (onComplete) {
        ...
        var jcrop_api;
        var bottom_html = "<input type='file' id='fileInput' name='files[]'/ accept='image/*'><input style='opacity: 0;' type='text' name='file' id='filePath'><canvas id='myCanvas' style='display:none;'></canvas><div id='modal'></div><div id='preview'><div class='buttons'><div class='cancel'></div><div class='ok'></div></div></div>";
        $('.simple-cropper-images').append(bottom_html);
        ...
        function imageUpload(dropbox) {
            ...
            if (file.type.match(imageType)) {
                ...
                reader.onload = function (e) {
                    ...
                    if (!is_crop) {
                        $("#filePath").val(original_data);
                        $(".cropme").html('<img style="width: 200px;" src="'+original_data+'">')
                        return false;
                    }
                    ...
                    current_image.onload = function () {
                        ...
                        let ratio = aspX / aspY;
                        if (typeof aspactRation !== 'undefined') {
                            ratio = aspactRation;
                        }
                        ias = $(this).Jcrop({
                            onSelect: showCoords,
