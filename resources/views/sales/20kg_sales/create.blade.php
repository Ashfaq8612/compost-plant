...
@section('contents')
    <div class="d-flex align-items-center justify-content-between">
        <h1 class="mb-0">20KG Sales Record</h1>
        <a href="{{ route('sales_20kg.index') }}" class="btn btn-secondary">Back to Sales</a>
    </div>
    <hr />
    @if ($errors->any())
    ...
    @endif
    <form action="{{ route('sales_20kg.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="form-row">
